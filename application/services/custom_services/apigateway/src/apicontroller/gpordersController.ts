...
export class gpordersController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/gporders/:id', this.GpDelete);
this.router.get('/gporders/get/search', this.GpSearch);
this.router.put('/gporders/get/update', this.GpSearchForUpdate);
this.router.put('/gporders', this.GpUpdate);
this.router.get('/gporders/:id', this.GpGetNounById);
this.router.get('/gporders', this.GpGetAllValues);
this.router.post('/gporders', this.GpCreate);
this.router.get('/gporders/userid/created_by', this.GpGetNounCreatedBy);
        //#@gepdelimeterone@#
        //#@ssofacebookapiroute@#
        //#@ssogithubapiroute@#
    }
...
public GpDelete(req: Request, res: Response) {
        ...
        new ApiAdapter().delete(Constant.GPORDERURL + `${req.url}` )
...
public GpSearch(req: Request, res: Response) {
        ...
        new ApiAdapter().get(Constant.GPORDERURL + `${req.url}` )
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpSearchForUpdate(req: Request, res: Response) {
        ...
        new ApiAdapter().put(Constant.GPORDERURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpCreate(req: Request, res: Response) {
        ...
        new ApiAdapter().post(Constant.GPORDERURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
